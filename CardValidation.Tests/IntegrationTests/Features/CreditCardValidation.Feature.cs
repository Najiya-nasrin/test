...
namespace CardValidation.Tests.IntegrationTests.Features
{
    ...
    [NUnit.Framework.CategoryAttribute("allure.owner:Faheem")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Missing Owner", "", "4111111111111111", "123", "12/30", "400", "Owner", null)]
        [NUnit.Framework.TestCaseAttribute("Missing Number", "Jane Doe", "", "123", "12/30", "400", "Number", null)]
        [NUnit.Framework.TestCaseAttribute("Missing CVV", "Jane Doe", "4111111111111111", "", "12/30", "400", "Cvv", null)]
        [NUnit.Framework.TestCaseAttribute("Missing IssueDate", "Jane Doe", "4111111111111111", "123", "", "400", "date", null)]
        [NUnit.Framework.TestCaseAttribute("Invalid Card Number", "Test User", "1234567890123456", "123", "12/30", "400", "Number", null)]
        [NUnit.Framework.TestCaseAttribute("Invalid CVV length Visa", "Clara Wells", "4111111111111111", "12", "12/30", "400", "Cvv", null)]
        [NUnit.Framework.TestCaseAttribute("Expired Card Past Date", "Expired User", "4111111111111111", "123", "01/21", "400", "date", null)]
        [NUnit.Framework.TestCaseAttribute("Owner Contains Number", "Jane 4111", "4111111111111111", "123", "12/30", "400", "Owner", null)]
        [NUnit.Framework.TestCaseAttribute("Owner Contains Card Number", "John 4111111", "4111111111111111", "123", "12/30", "400", "Owner", null)]
        [NUnit.Framework.TestCaseAttribute("CVV with special chars", "Jane Doe", "4111111111111111", "12@#", "12/30", "400", "Cvv", null)]
        [NUnit.Framework.TestCaseAttribute("Card Number with spaces", "John Doe", "4111 1111 1111 1111", "123", "12/30", "400", "Number", null)]
...
#line 8
    await testRunner.GivenAsync(string.Format("this is test case \"{0}\"", testCaseName), ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
...
#line 9
    await testRunner.AndAsync("I prepare a credit card with:", ((string)(null)), table1, "And ");
#line hidden
#line 12
...
#line hidden
#line 14
    await testRunner.AndAsync(string.Format("the response body should contain \"{0}\"", expectedResult), ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
